function Hero(){
    return(
      ...
      <div className="px-2 sm:px-4 text-center text-white font-bold sm:text-green text-7xl sm:text-7xl md:text-8xl sm:mt-8 h-screen flex flex-col justify-center items-center">
        <h1>
